...
|------|-------|-----|-------|-----|
| 09:00 | Begrüßung & Kursziel | Aufbau beider Tage, Bezug PL-600 | TN soll den roten Faden kennen, bevor Inhalte beginnen | — |
...
| 11:35 | Architekturqualität & Anti-Pattern | Warnsignale in bestehenden Lösungen erkennen | TN hat 2,5 Jahre Praxis — viele dieser Muster werden bekannt sein | 0105 |
...
| 14:05 | Erweiterungsoptionen auswählen | Konfiguration → Formel → Flow → Plugin → Azure Function — wann was? | Explizites Lernziel des TN: wann welche Erweiterung sinnvoll? | 0205 |
...
| 15:30 | Copilot Studio als SA-Baustein | Topics, Knowledge, Actions, Governance für Agents | TN hat keine Erfahrung damit — SA-Perspektive: wann einsetzen, was governt werden muss | 0401–0404 |
...
| 10:05 | Sicherheitsrollen & Berechtigungstiefe | 8 Typen inkl. Append/Append To. **Rollen kumulieren — niemals einschränken** | TN kennt Rollen, aber Kumulierungsprinzip wird häufig falsch verstanden | 0503 |
...
> **Hinweis Trainer:** TN hat APIs als expliziten Schwerpunkt genannt — hier gerne tiefer gehen und Zeit flexibel dehnen.
...
| 14:10 | Plugin-Pipeline | 4 Phasen: Pre-Val, Pre-Op, Post-Op sync, Post-Op async. Anti-Pattern: synchroner HTTP-Call im Plugin | TN hat JS und Flows — Plugins sind der nächste Schritt | 0703 |
...
| 15:35 | PP Pipelines & Azure DevOps | PP Pipelines (eingebaut, kein ADO nötig) vs. ADO Build Tools (YAML, CI/CD). Service Principal für Pipelines | TN kennt pac CLI manuell — nächster Schritt zur Pipeline-Automatisierung | 0803 |
| 15:50 | Kursabschluss | PL-600 Prüfungsformat, häufig getestete Themen, Registrierung, Ressourcen | TN plant Zertifizierung Juni 2026 | — |
